...
// daftar alamat
Route::get('/master/kecamatan/get_data', [\App\Http\Controllers\Sibenih\KecamatanController::class, 'get_data'])->name('master.kecamatan.get_data');
Route::resource('daftaralamat', \App\Http\Controllers\Sibenih\DaftarAlamatController::class);
